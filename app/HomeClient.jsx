    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="container mx-auto h-full relative z-10">
          <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24 h-full">
            ...
            <div className="text-center xl:text-left order-2 xl:order-none max-w-2xl">
              ...
              >
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {/* Secondary Button */}
                  <Link href="/documents/Mohammed-Naeem-Ahmed-CV.pdf" target="_blank" rel="noopener noreferrer">
                    <motion.div
                      whileHover={{ scale: 1.05, y: -2 }}
                      whileTap={{ scale: 0.95 }}
                      className="group"
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4">
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-2xl xl:text-3xl font-bold text-center text-white mb-8"
          >
